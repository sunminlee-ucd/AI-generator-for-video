...
- picture_in_picture: overlay an uploaded secondary video. Set secondary_asset_id and x/y/width/height.
- masked_video: play the source video inside a circle/star/heart/triangle while an uploaded secondary video plays behind it. secondary_asset_id is the background video.
...
5. Do not add style_transfer for ordinary cuts, speed, audio, text, layout, masks, or music edits.
